...
def chk():
  ...
  try: 
    httpCaht = requests.get("https://pastebin.com/3WAfzGx1").text 
    if id in httpCaht: 
      ...
      os.system('xdg-open  https://www.facebook.com/laila.salh.52813*')
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
...
def login_lagi334():
	...
	try:
		...
		print("\n run : python jee.py")
		os.system('https://www.facebook.com/laila.salh.52813')
		exit()
	except Exception as e:
...
def menu(my_name,my_id):
	...
	if jh in ['1','01']:
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/laila.salh.52813"])
	elif jh in ['4','04']:
		subprocess.check_output(["am", "start", "https://www.facebook.com/laila.salh.52813"])
	elif jh in ['6','06']:
		os.system("rm -f .cok.txt")
